  ...
  const data = [
    {
      ...
      title: 'Anum ❤️',
      message: [
        { text: 'Jaldi complete kro project anum', time: '10:01 AM' },
        { text: 'Thora sa code reh gya hai', time: '10:05 AM' },
        { text: 'Kal submit krwana hai', time: '10:10 AM' },
        { text: 'Time kam hai jaldi kro', time: '10:15 AM' },
        { text: 'Code push krdo GitHub pr', time: '10:20 AM' },
